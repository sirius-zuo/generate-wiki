...
mechanically — `git log --since=<page's last commit> -- <anchors>` lists
...
gates train contributors to make no-op doc edits. Run
`{{WIKI_DIR}}/../scripts/check-wiki.sh` (or the copy materialized next to
this file) to verify structural conventions.
